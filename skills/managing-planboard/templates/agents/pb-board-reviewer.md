...
description: One reviewer seat for the research-plans board — reviews a plan version, the master plan, or a results bundle and returns a few high-value, section-anchored comments. Dispatched by /planboard:board review requests, singly or as a three-lens panel.
model: {{MODEL}}
effort: {{EFFORT}}
